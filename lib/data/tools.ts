...
export const tools: CalculatorTool[] = [
    ...
    faqs: [
      {
        ...
        answer:
          "프로젝트와 적용 규정에 따릅니다. 저압에서 분기 3%, 간선 5% 수준의 실무 지침이 흔하나, 본 도구는 그 값을 강제하지 않고 참고 경고만 표시합니다.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: "부하전류에 여유율을 곱한 참고용 최소 정격 전류를 제시합니다.",
    longDescription:
      "계산된 또는 측정된 부하전류에 사용자 지정 여유율을 적용해 참고용 차단기 정격 전류를 표시합니다. 단락용량, 보호협조, 모터 기동은 포함하지 않습니다.",
    ...
    faqs: [
      {
        ...
        answer:
          "아니요. 단락전류, 선택차단, 케이블 허용전류, 제조사 특성곡선을 확인해야 합니다. 이 도구는 부하전류 여유만 반영한 참고값입니다.",
      },
    ],
  },
  {
